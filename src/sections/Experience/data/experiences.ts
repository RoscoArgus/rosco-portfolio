    ...
    roles: [
      {
        ...
        description:
          "I worked as a host in one of Ireland's busiest cinemas, providing enjoyable and memorable guest experiences through food & beverage sales and ushering in line with company visions and values.",
      },
    ],
    highlights: [
    ...
    roles: [
      {
        ...
        description:
          "I worked as an operations assistant for Trinity's innovation and enterprise hub, Portal, assisting with daily operations and event management, acting as support staff for corportate gatherings.",
      },
    ],
    highlights: [
